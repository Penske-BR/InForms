...
export default class AvariaPDF{
    #setFileSize() {    
        const doc = new jsPDF({
    ...
    #setInfos(PDFReportObj) {
        this.doc.text((this.currentDate.date + " - " + this.currentDate.time), 65, 225)
    ...
    #setTableInfos(PDFReportObj) {
        ...
        this.doc.setTextColor(0, 0, 0)
        this.doc.text(PDFReportObj.Local[2], 400, 490)

        this.doc.setTextColor(255, 255, 255)
        this.doc.text("Estado", 665, 465)
        this.doc.setTextColor(0, 0, 0)
        this.doc.text(PDFReportObj.Local[0], 630, 490)

        this.doc.setTextColor(255, 255, 255)
        this.doc.text("Cidade", 785, 465)
        this.doc.setTextColor(0, 0, 0)
        this.doc.text(PDFReportObj.Local[1], 755, 490)
    }
    ...
    #createImageField(){
        try {
            ...
            console.log(this.compressedImages.images[0].slice(0, 30))
            console.log(this.compressedImages.imageFormats[0])
