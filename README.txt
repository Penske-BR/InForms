...
InForms é um sistema simples e direto para o registro de inconformidades em mercadorias. Através de um formulário, os usuários preenchem as informações necessárias, e ao final, um arquivo PDF é gerado automaticamente com todos os dados inseridos.
